...
install:	
		sudo rm -f *~ *.o $(PROG) # just to be sure that $(PROG) is rebuilt later. Is this necessary?
	 	sudo install -m 0755 $(LIBRESISTANCE) $(LOCALLIBDIR) # copies the libraries. Add your libs here
	 	$(CC) $(CFLAGS) -o $(PROG) main.c $(RESISTANCE_LIBFLAG_PUBLIC) # add your libs here
